        ...
        >
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.div variants={itemVariants} className="flex justify-center lg:justify-start space-x-6">
              <a 
                href="https://www.instagram.com/khankriyal__rohit/" 
                className="p-3 border border-border rounded-full hover:border-primary hover:bg-primary/10 transition-all duration-300 hover:scale-110"
              >
                <Instagram className="w-5 h-5" />
              </a>
              <a 
                href="https://github.com/khankriyalrohit" 
                className="p-3 border border-border rounded-full hover:border-primary hover:bg-primary/10 transition-all duration-300 hover:scale-110"
              >
                <Github className="w-5 h-5" />
              </a>
              <a 
                href="https://www.linkedin.com/in/rohit-khankriyal-359680242/" 
                className="p-3 border border-border rounded-full hover:border-primary hover:bg-primary/10 transition-all duration-300 hover:scale-110"
              >
          ...
          >
            <div className="relative">
              ...
              <img
                src={profileImage}
                alt="Rohit Khankriyal"
                className="relative w-80 h-80 sm:w-96 sm:h-96 object-cover rounded-full shadow-2xl"
              />
